...
eval_model_en() {
    ...
    # OLD
    # lighteval accelerate tmp_config.yaml "mmlu|0,hellaswag|0" --max-samples 500

    # NEW
    python misc/patch_mmlu_metric.py accelerate tmp_config.yaml "mmlu|0,hellaswag|0" --max-samples 8000
