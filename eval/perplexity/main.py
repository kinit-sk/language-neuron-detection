...
def calculate_metrics(
    ...
    device = next(model.parameters()).device
    if max_samples:
        print(f"\n{ORANGE}[WARN]{RESET} Evaluating on {max_samples} samples, this should be used for debugging only!\n")
...
@hydra.main(version_base=None, config_path="configs", config_name="benczech_big")
